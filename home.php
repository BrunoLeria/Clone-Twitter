		...
		<script type="text/javascript">
			...
			$(document).ready( function () {
				...
				function atualizaTweet(){
					//carrega os tweets depois de carregar a página
	    			...
	    			<div class="panel-body">
	    				<form id="form_tweet" class="input-group">
	    					...
	    					<span class="input-group-btn">
	    						<button id="btn_tweet" type="button" class="btn btn-default">Tweet</button>
	    					</span>
	    				</form>
	    			</div>
	    		</div>

	    		<article id="tweets" class="list-group"></article>
