	...
	<head>
		...
		<script type="text/javascript">
			...
			$(document).ready( function () {
				...
				//associar o evento de clique ao botão Procurar
				$('#btn_procurar_pessoa').click( function(){
					if ($('#nome_pessoa').val().length > 0) {
						...
						$.ajax({
							url: 'get_pessoas.php',
							method: 'post',
							//para recuperar vários inputs sem ter que recarregar a página
							...
							success: function(data){
								...
								$('.btn_seguir').click( function(){
									...
									$.ajax({
										url: 'seguir.php',
										method: 'post',
										data: {seguindo_id_usuario: id_usuario},
										success: function(data){
										}
									});
								});
								...
								$('.btn_deixar_seguir').click( function(){
									...
									$.ajax({
										...
										method: 'post',
										data: {deixar_seguindo_id_usuario: id_usuario},
										success: function(data){
										}
									});
								});
	    			...
	    			<div class="panel-body">
	    				<form id="form_procurar_pessoas" class="input-group">
	    					...
	    					<span class="input-group-btn">
	    						<button id="btn_procurar_pessoa" type="button" class="btn btn-default">Procurar</button>
	    					</span>
	    				</form>
	    			</div>
	    		</div>

	    		<article id="pessoas" class="list-group"></article>
